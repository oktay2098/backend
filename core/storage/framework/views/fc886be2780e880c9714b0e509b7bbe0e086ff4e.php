                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-12">
                                <div class="table-area">
                                    <div class="col-md-2">
                                        <a href="<?php echo e(route('user.service.create')); ?>" class="btn btn-sm btn--success box--shadow1 text--small"style="background-color: #198754; color: #ffffff; border-radius: 5px; ><i class="fa fa-fw fa-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
                                    </div>
                                                    ...
                                                    <td data-label="<?php echo app('translator')->get('Title'); ?>" class="text-start">
                                                        <div class="author-info">
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <a href="<?php echo e(route('service.details', [slug($service->title), encrypt($service->id)])); ?>" title=""><?php echo e(__(str_limit($service->title, 30))); ?></a>
                                                                <?php else: ?>
                                                                <a href="#" title=""><?php echo e(__(str_limit($service->title, 30))); ?></a>
                                                                <?php endif; ?>
                                                            </div>
                                                    </td>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/backend/core/resources/views/templates/basic/user/seller/service/index.blade.php ENDPATH**/ ?>