                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="Action">
                                                        ...
                                                        @if($hireEmploy->working_status==2)
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn--danger text-white disputeBtn ms-1" data-order_number="{{$hireEmploy->order_number}}" data-bs-toggle="modal" data-bs-target="#disputeModal"><i class="las la-times"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @empty
