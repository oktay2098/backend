                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-12">
                                <div class="table-area">
                                        <div class="col-md-2">
                                        <a href="{{route('user.job.create')}}" class="btn btn-sm btn--success box--shadow1 text--small"style="background-color: #198754; color: #ffffff; border-radius: 5px; ><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
                                    </div>
