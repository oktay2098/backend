                                                                    ...
                                                                    @if($software->demo_url)
                                                                        <a href="{{$software->demo_url}}"
                                                                           ...
                                                                           class="btn--base text-white"><i
                                                                                    class="las la-shopping-cart"></i>@lang('Preview')
                                                                        </a>
                                                                    @else
                                                                        <a href="#" class="btn--base text-white disabled"><i
                                                                                    class="las la-shopping-cart"></i>@lang('Preview')
                                                                        </a>
                                                                    @endif
                                                                </div>
                                                                ...
                                                                <div class="right mb-20">
                                                                    ...
                                                                    @else
                                                                        <a href="#" target="__blank"
                                                                           class="btn--base text-white disabled"><i
                                                                                    class="las la-shopping-cart"></i>@lang('Preview')
                                                                        </a>
                                                                    @endif
                                                                </div>
                                                                            ...
                                                                            <div class="rating">
                                                                                ...
                                                                                <input type="radio" id="star4"
                                                                                       name="rating" value="2"/><label
                                                                                        for="star4" title="Kinda bad">&nbsp;</label>
                                                                            ...
                                                                            <li class="comment-container d-flex flex-wrap">
                                                                                ...
                                                                                <div class="comment-box">
                                                                                    ...
                                                                                    <div class="comment-info mb-1">
                                                                                        ...
                                                                                        -
                                                                                        <span class="comment-date">{{showDateTime($review->created_at, 'd M Y')}}</span>
                                                                                    </div>
                                                                    ...
                                                                    @if($reviews->total() > 7)
                                                                        <div class="view-more-btn text-center mt-4">
                                                                            <a href="javascript:void(0)"
                                                                               ...
                                                                               data-page="2"
                                                                               data-link="{{route('software.details', [slug($software->title), encrypt($software->id)])}}?page="> @lang('View More')</a>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                                                    ...
                                                                                    <div class="comment-top-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                                                                        <div class="left">
                                                                                            <div class="comment-info">
                                                                                                ...
                                                                                                -
                                                                                                <span class="comment-date">{{showDateTime($comment->created_at, 'd M Y')}}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="comment-text">
                                                                                        ...
                                                                                        <div class="comment-top-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                                                                            <div class="left">
                                                                                                <div class="comment-info">
                                                                                                    ...
                                                                                                    -
                                                                                                    <span class="comment-date">{{showDateTime($replyComment->created_at, 'd M Y')}}</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="comment-text">
                                    ...
                                    <div class="col-xl-3 col-lg-3 mb-30">
                                        <div class="sidebar">
                                                ...
                                                <div class="widget-btn mt-20">
                                                    <a href="{{route('user.software.buy',[slug($software->title), encrypt($software->id)])}}"
                                                       class="btn--base w-100">@lang('Buy Now')
                                                        ({{$general->cur_sym}}{{showAmount($software->amount)}})</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="widget custom-widget text-center mb-30">
                                                <h3>
                                                    <i class="fas fa-shopping-cart"></i> {{$softwareSales}} @lang('Sales')
                                                </h3>
                                            </div>
                                                                ...
                                                                <div class="right">
                                                                    <div class="order-btn">
                                                                        <a href="{{route('user.service.booking', [slug($other->title), encrypt($other->id)])}}"
                                                                           class="btn--base"><i
                                                                                    class="las la-shopping-cart"></i> @lang('Order Now')
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
